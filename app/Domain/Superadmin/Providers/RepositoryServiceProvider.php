...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        \App\Domain\Superadmin\Repositories\Contracts\SuperadminRepository::class => \App\Domain\Superadmin\Repositories\Eloquent\SuperadminRepositoryEloquent::class,
