...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        \App\Domain\Postcomment\Repositories\Contracts\PostcommentRepository::class => \App\Domain\Postcomment\Repositories\Eloquent\PostcommentRepositoryEloquent::class,
